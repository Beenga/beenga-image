...
const PERSON = /\b(woman|women|man|men|girl|boy|lady|ladies|person|people|couple|friends?|family|group|crowd|child|children|kid|student|model|portrait|face|hair|male|female|guy|gentleman|bride|groom)\b/i;
const HAIR_REALISM =
...
const LIGHTING = /\b(light|lighting|lit|sunset|sunrise|golden\s+hour|night|dusk|dawn|shade|shadow|backlit|neon|candle|lamp|studio|overcast|cloudy|moody|dark|silhouette)\w*\b/i;
...
const SETTING_NAMED = new RegExp(VENUE.source + "|\\b(market|bazaar|temple|gym|shop|beach|hill|mountain|village|farm|airport|hospital|library|museum|stadium|terrace)\\w*\\b", "i");
const SCENES = [
