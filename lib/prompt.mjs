...
const pickLook = (s) => {
  ...
  return SARI_LOOKS[h % SARI_LOOKS.length];
};
...
// clean-shaven. One rule rather than four, because each addition dilutes every
...
const HOUSE_LOOK = "fair complexion, sharp well-defined features, conventionally attractive.";
