...
const FRAGILE = [
  ...
  { test: /\bdeep\s+(dark\s+)?complexion\b|\bdark\s+skin(ned)?\b/i,
    say: "The complexion is genuinely deep, rich dark brown skin with warm depth." },
  { test: /\bwheatish\b/i,
    say: "The complexion is wheatish medium brown with neutral warmth." },
