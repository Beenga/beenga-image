...
const TRADITIONAL_INTENT = new RegExp(
  "\\b(traditional|classical|lehenga|sherwani|ghagra|ghaghra|achkan|jodhpuri|mundu|veshti|dhoti|angavastram|pattu|langa|bharatanatyam|kathak|kuchipudi|odissi|bhangra|garba|" +
...
const FULL_FRAME = "The full figure is inside the frame, from head to feet.";
...
const PERSON_WORD = new RegExp(
  ...
  "youth|toddler|infant|baby|grandmother|grandfather|granny|" +
  ...
  "chef|cook|waiter|guard|officer|policeman|soldier|priest|artist|musician|" +
  "dancer|singer|player|athlete|actor|actress|influencer|blogger|" +
  "customer|passenger|commuter|shopper|pedestrian|villager|" +
  // generic descriptors
  "someone|somebody|individual|figure|subject|character|human)\\b", "i");
...
const SETTING_NAMED = new RegExp(
  ...
  "pool|poolside|bathtub|shower|mirror|window)\\w*\\b" +
  ...
  "sitting\\s+room|waiting\\s+room|kitchen)\\w*\\b" +
  ...
  "bedside|sofa|couch|armchair|worktop|countertop|counter|dresser|nightstand)\\w*\\b" +
  "|\\b(market|bazaar|temple|gym|shop|beach|hill|mountain|village|farm|airport|" +
  "hospital|library|museum|stadium|terrace)\\w*\\b", "i");
