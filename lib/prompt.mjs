...
const PERSON_WORD = /\b(woman|women|man|men|girl|boy|lady|ladies|person|people|couple|friends?|family|group|crowd|child|children|kid|student|model|portrait|face|hair|male|female|guy|gentleman|bride|groom)\b/i;
